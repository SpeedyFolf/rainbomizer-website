...
export default {
    ...
    methods: {
      ...
      fetchData() {
        fetch("https://api.github.com/repos/Parik27/IV.EFLC.Rainbomizer/releases/latest")
          .then(data => data.json())
          .then(data => {
            this.download = {
              ...
              buttonText: `Download GTA IV/Episodes from Liberty City Rainbomizer ${data.tag_name}`
            }
            }).catch(e => {
